...
export const Nav = () => {
    ...
    return (
        <nav>
            <ul className='nav-ul'>
                <li>
                    <NavLink to='/' className={`nav-link ${active === '/'?'acive':''}`}>
                ...
                <li>
                    <NavLink to='/projects' className={`nav-link ${active === '/projects'?'acive':''}`}>
                ...
                <li>
                    ...
                    <NavLink to='/about' className={`nav-link ${active === '/about'?'acive':''}`}>
                ...
                <li>
                    ...
                    <NavLink to='/blog' className={`nav-link ${active === '/blog'?'acive':''}`}>
